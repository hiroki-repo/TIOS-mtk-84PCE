...
_em180:
	...
	push iy
	ld a,mb
	ld (em180_stack4z80inst+(3*13)+2),a
	ld a,(em180_stack4z80inst+(3*13)+1)
	ld mb,a
	ld (em180_spbak),sp
...
em180_fetch:
	...
	ld (em180_stack4z80inst+(3*14)),a
	ld a,(em180_stack4z80inst+(3*13)+0)
	ld (em180_opctmp-1),a
	ld (em180_fetch8),a
	ld (em180_fetch8_),a
em180_fetch_1:
...
em180_exec_trcode:
	...
	ld (em180_spbak+3),sp
	;ld sp,(em180_spbak)
	ld sp,(em180_stack4z80inst+(3*12))
em180_opctmpwp:
	db 040h
em180_opctmp:
	nop
...
em180_skip4ncc:
	ld (em180_stack4z80inst+(3*12)),sp
	;ld (em180_spbak),sp
	ld sp,(em180_spbak+3)
...
em180_call_adl:
	...
	ld hl,0
	add hl,sp
	ld (em180_stack4z80inst+(3*12)),hl
	ld a,(em180_stack4z80inst+(3*14))
	and a,a
	jr nz,em180_call_adl__
em180_call_adl_:
	jr em180_jp_adl
em180_call:
	ld hl,(em180_stack4z80inst+(3*11))
...
em180_jp_:
	...
	jp em180_rettocallee
em180_jp__:
	ld (em180_stack4z80inst+(3*13)+0),a
	jr em180_jp_
em180_call_adl__:
	;ld a,(em180_stack4z80inst+(3*14))
	;ld (em180_stack4z80inst+(3*13)+0),a
...
em180_jr:
	...
	adc a,0
	ld h,a
	ld a,(em180_stack4z80inst+(3*11)+2)
	adc a,0
	ld (em180_stack4z80inst+(3*11)),hl
	ld (em180_stack4z80inst+(3*11)+2),a
	;jp em180_fetch
	jp em180_rettocallee
em180_jr_1:
	ld b,a
...
em180_rettocallee:
	ld a,mb
	ld (em180_stack4z80inst+(3*13)+1),a
	ld a,(em180_stack4z80inst+(3*13)+2)
	ld mb,a
	ld sp,(em180_spbak)
	pop iy
	pop ix
